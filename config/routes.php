...
$app->group('/api', function () {
    ...
    $this->get('/getShopList', App\Controllers\ApiController::class . ':getShopList');
    $this->get('/getAnnList', App\Controllers\ApiController::class . ':getAnnList');
    $this->post('/connect', App\Controllers\ApiController::class . ':connect');
});
...
//API Router
$app->group('/api', function () {
    $this->post('/user/login', App\Controllers\Routers\UserController::class . ':login');
});
